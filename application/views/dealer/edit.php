			...
			<?php foreach ($list as $data) { ?>
				<form action="<?php echo base_url('dealerc/update_dealer/') . $data['id'] ?>" method="POST">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="name" value="<?php echo $data['name'] ?>" placeholder="Enter name"
							name="name">
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input type="company_name" class="form-control" id="company_name" value="<?php echo $data['company_name'] ?>"
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="area" value="<?php echo $data['area'] ?>" placeholder="Enter Area"
							name="area">
					</div>
					<div class="form-group">
						<label for="mobile_no">Phone Number</label>
						<input type="number" class="form-control" id="mobile_no" value="<?php echo $data['mobile_no'] ?>"
							placeholder="Enter Phone Number" name="mobile_no">
					</div>

        ...
        <tbody>
          ...
          foreach ($list as $data) { ?>
            <tr>
              ...
              <td style="text-align: center;"><a href="<?php echo base_url('userc/update_form/') . $data['id']; ?>"
                  class="btn btn-success">Update</a><a href="<?php echo base_url('userc/delete/') . $data['id'] ?>"
